...
const Profile = () => {
  ...
  return (
    <div id="Profile" style={{ }}>
      ...
      >
        <h2 style={{ padding:'15px 0', fontWeight:'bold', color:'#1e3a63',textDecoration:'underline'}}>Login User Dashboard</h2>
        <p style={{ textAlign:'center', color:'gray', fontSize:'14px', padding:'0 0 10px 0'}}>Here you can view your profile information.</p>
      </Flex>
      <Table dataSource={data} columns={columns} loading={loading} bordered title={we}/>
    </div>
  );
};
