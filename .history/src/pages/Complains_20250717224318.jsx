...
const DeleteApiData = async(id) =>{
  ...
  return (
    <div id='Complains'>
      ...
      >
      <p style={{marginLeft:'20px',textAlign:'center', color:'gray', fontSize:'14px', padding:' 0 0 10px 0'}}>Here you can view and manage all your complaints, delete them if necessary.</p>
        <ComplainFormModal />
      </Flex>
      <Table
        columns={columns}
