...
const LoginPage = () => {
  ...
  return (
    ...
    <div id="LoginPage" style={{backgroundColor: '#f0f2f5', padding: '0px 20px', height: '80vh'}}>
      ...
      <div id="c2">
      <Card title="Sign In" style={{  margin: "0 auto", marginTop: "10px", alignItems: "center",  textAlign: "center", color:'#1e3a63', backgroundColor: '#44c2b8b7', padding: '20px', borderRadius: '30px', boxShadow: '0 2px 10px rgba(0, 0, 0, 0.3)' }}>
        <Form onFinish={onFinish}>
          {/* for email */}
          <Form.Item label="Email" name="email" required>
            <tr>
            <Input placeholder="email"  style={{width:'max-content'}}/>
            </tr>
          </Form.Item>
          {/* for password */}
