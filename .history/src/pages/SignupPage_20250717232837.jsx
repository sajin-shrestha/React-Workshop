...
const SignupPage = () => {
  ...
  return (
    <div id="SignUpPage">
      <Card title="Sign Up" style={{  margin: "0 auto", marginTop: "10px", alignItems: "center",  textAlign: "center", color:'#1e3a63', backgroundColor: '#44c2b8b7', padding: '20px', borderRadius: '50px', boxShadow: '0 2px 10px rgba(0, 0, 0, 0.1)' }}>
