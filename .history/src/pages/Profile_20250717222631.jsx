...
const Profile = () => {
  ...
  return (
    <div id="Profile" style={{ padding: "20px", backgroundColor: "#f0f0f0", borderRadius: "10px", boxShadow: "0 2px 10px rgba(0, 0, 0, 0.4)" , margin: '20px'}}>
      ...
      >
        <h2 style={{ padding:'15px 0'}}>Profile page for Login User Dashboard</h2>
        <p style={{ textAlign:'center', color:'gray', fontSize:'14px', padding:'0 0 10px 0'}}>Here you can view and edit your profile information.</p>
      </Flex>
