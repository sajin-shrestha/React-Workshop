...
const DeleteApiData = async(id) =>{
  ...
  return (
    <div id='Complains'>
      <h2 style={{fontWeight:'bold', alignItems:'center', textAlign:'center', padding:'15px 0'}}>Complains Viewing and Adding</h2>
      <p style={{textAlign:'center', color:'gray', fontSize:'14px', padding:' 0 0 10px 0'}}>Here you can view and manage all your complaints.</p>
      <Flex
        wrap="wrap"
        align="center"
        justify="end"
