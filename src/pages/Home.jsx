import { Space, Table, Tag, Typography, Image, Card, Spin, Empty } from 'antd'
  ...
  return (
    <div className="data-table-container">
      <div className="data-table-header">
        <Title level={2}>Government Organizations</Title>
        <Paragraph>
          Below is a list of government organizations and their information.
        </Paragraph>
      </div>
